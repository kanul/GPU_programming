...
int main(int argc, char* argv[])
{
	...
	// ****************
	// TODO : Map a region of the buffer object into the host address space
	// ****************
	float *h_a, *h_b, *h_r;
	cstart = clock();
	// Fill Code
	...
	*/
	...
	// ****************
	// TODO : Unmap memory object to transfer data from host to device
	// ***************
	cstart = clock();
	// Fill Code
	cend = clock();
	...
	*************************************************/
	...
	// ****************
	// TODO : Read back the results from the compute device by using clEnqueueMapbuffer
	// ****************
	// Fill Code
